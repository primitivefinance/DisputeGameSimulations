...
pub mod dispute_game_factory_init {
    ...
    pub static DISPUTEGAMEFACTORY_INIT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct DisputeGameFactory_Init<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for DisputeGameFactory_Init<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for DisputeGameFactory_Init<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for DisputeGameFactory_Init<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for DisputeGameFactory_Init<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DisputeGameFactory_Init))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DisputeGameFactory_Init<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    DISPUTEGAMEFACTORY_INIT_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                DISPUTEGAMEFACTORY_INIT_ABI.clone(),
                DISPUTEGAMEFACTORY_INIT_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            DisputeGameFactory_InitEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for DisputeGameFactory_Init<M> {
    ...
    pub enum DisputeGameFactory_InitEvents {
    ...
    impl ::ethers::contract::EthLogDecode for DisputeGameFactory_InitEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = DisputeGameCreatedFilter::decode_log(log) {
                return Ok(
                    DisputeGameFactory_InitEvents::DisputeGameCreatedFilter(decoded),
                );
            }
            if let Ok(decoded) = ImplementationSetFilter::decode_log(log) {
                return Ok(
                    DisputeGameFactory_InitEvents::ImplementationSetFilter(decoded),
                );
            }
            if let Ok(decoded) = OutputProposedFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::OutputProposedFilter(decoded));
            }
            if let Ok(decoded) = OutputsDeletedFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::OutputsDeletedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    DisputeGameFactory_InitEvents::OwnershipTransferredFilter(decoded),
                );
            }
            if let Ok(decoded) = TransactionDepositedFilter::decode_log(log) {
                return Ok(
                    DisputeGameFactory_InitEvents::TransactionDepositedFilter(decoded),
                );
            }
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogAddressFilter(decoded));
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogArray1Filter(decoded));
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogArray2Filter(decoded));
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogArray3Filter(decoded));
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogBytesFilter(decoded));
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedAddressFilter(decoded));
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedArray1Filter(decoded));
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedArray2Filter(decoded));
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedArray3Filter(decoded));
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedBytesFilter(decoded));
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    DisputeGameFactory_InitEvents::LogNamedDecimalIntFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    DisputeGameFactory_InitEvents::LogNamedDecimalUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedStringFilter(decoded));
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogNamedUintFilter(decoded));
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogStringFilter(decoded));
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogUintFilter(decoded));
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(DisputeGameFactory_InitEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for DisputeGameFactory_InitEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for DisputeGameFactory_InitEvents {
    ...
    impl ::core::convert::From<OutputProposedFilter> for DisputeGameFactory_InitEvents {
        fn from(value: OutputProposedFilter) -> Self {
            Self::OutputProposedFilter(value)
        }
    }
    impl ::core::convert::From<OutputsDeletedFilter> for DisputeGameFactory_InitEvents {
    ...
    impl ::core::convert::From<LogFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogFilter) -> Self {
            Self::LogFilter(value)
        }
    }
    impl ::core::convert::From<LogAddressFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogAddressFilter) -> Self {
            Self::LogAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogArray1Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogArray1Filter) -> Self {
            Self::LogArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogArray2Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogArray2Filter) -> Self {
            Self::LogArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogArray3Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogArray3Filter) -> Self {
            Self::LogArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogBytesFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogBytesFilter) -> Self {
            Self::LogBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogBytes32Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogBytes32Filter) -> Self {
            Self::LogBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogIntFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogIntFilter) -> Self {
            Self::LogIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedAddressFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedAddressFilter) -> Self {
            Self::LogNamedAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray1Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedArray1Filter) -> Self {
            Self::LogNamedArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray2Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedArray2Filter) -> Self {
            Self::LogNamedArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray3Filter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedArray3Filter) -> Self {
            Self::LogNamedArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytesFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedBytesFilter) -> Self {
            Self::LogNamedBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytes32Filter> for DisputeGameFactory_InitEvents {
    ...
    impl ::core::convert::From<LogNamedIntFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedIntFilter) -> Self {
            Self::LogNamedIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedStringFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedStringFilter) -> Self {
            Self::LogNamedStringFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedUintFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogNamedUintFilter) -> Self {
            Self::LogNamedUintFilter(value)
        }
    }
    impl ::core::convert::From<LogStringFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogStringFilter) -> Self {
            Self::LogStringFilter(value)
        }
    }
    impl ::core::convert::From<LogUintFilter> for DisputeGameFactory_InitEvents {
        fn from(value: LogUintFilter) -> Self {
            Self::LogUintFilter(value)
        }
    }
    impl ::core::convert::From<LogsFilter> for DisputeGameFactory_InitEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum DisputeGameFactory_InitCalls {
        IsTest(IsTestCall),
    ...
    impl ::ethers::core::abi::AbiDecode for DisputeGameFactory_InitCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for DisputeGameFactory_InitCalls {
    ...
    impl ::core::fmt::Display for DisputeGameFactory_InitCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsTestCall> for DisputeGameFactory_InitCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall> for DisputeGameFactory_InitCalls {
        fn from(value: ExcludeArtifactsCall) -> Self {
            Self::ExcludeArtifacts(value)
        }
    }
    impl ::core::convert::From<ExcludeContractsCall> for DisputeGameFactory_InitCalls {
        fn from(value: ExcludeContractsCall) -> Self {
            Self::ExcludeContracts(value)
        }
    }
    impl ::core::convert::From<ExcludeSendersCall> for DisputeGameFactory_InitCalls {
        fn from(value: ExcludeSendersCall) -> Self {
            Self::ExcludeSenders(value)
        }
    }
    impl ::core::convert::From<FailedCall> for DisputeGameFactory_InitCalls {
        fn from(value: FailedCall) -> Self {
            Self::Failed(value)
        }
    }
    impl ::core::convert::From<ProposeAnotherOutputCall>
    for DisputeGameFactory_InitCalls {
        fn from(value: ProposeAnotherOutputCall) -> Self {
            Self::ProposeAnotherOutput(value)
        }
    }
    impl ::core::convert::From<SetUpCall> for DisputeGameFactory_InitCalls {
    ...
    impl ::core::convert::From<TargetArtifactsCall> for DisputeGameFactory_InitCalls {
        fn from(value: TargetArtifactsCall) -> Self {
            Self::TargetArtifacts(value)
        }
    }
    impl ::core::convert::From<TargetContractsCall> for DisputeGameFactory_InitCalls {
        fn from(value: TargetContractsCall) -> Self {
            Self::TargetContracts(value)
        }
    }
    impl ::core::convert::From<TargetSelectorsCall> for DisputeGameFactory_InitCalls {
        fn from(value: TargetSelectorsCall) -> Self {
            Self::TargetSelectors(value)
        }
    }
    impl ::core::convert::From<TargetSendersCall> for DisputeGameFactory_InitCalls {
        fn from(value: TargetSendersCall) -> Self {
            Self::TargetSenders(value)
        }
    }
    impl ::core::convert::From<WarpToProposeTimeCall> for DisputeGameFactory_InitCalls {
