...
pub mod game_player {
    ...
    pub static GAMEPLAYER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct GamePlayer<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for GamePlayer<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for GamePlayer<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for GamePlayer<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for GamePlayer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(GamePlayer)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> GamePlayer<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                GAMEPLAYER_ABI.clone(),
                GAMEPLAYER_BYTECODE.clone().into(),
                client,
            );
    ...
    impl ::ethers::core::abi::AbiDecode for GamePlayerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GamePlayerCalls {
    ...
    impl ::core::fmt::Display for GamePlayerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ClaimAtCall> for GamePlayerCalls {
        fn from(value: ClaimAtCall) -> Self {
            Self::ClaimAt(value)
        }
    }
    impl ::core::convert::From<ClaimAtWithPositionCall> for GamePlayerCalls {
        fn from(value: ClaimAtWithPositionCall) -> Self {
            Self::ClaimAtWithPosition(value)
        }
    }
    impl ::core::convert::From<FailedToStepCall> for GamePlayerCalls {
        fn from(value: FailedToStepCall) -> Self {
            Self::FailedToStep(value)
        }
    }
    impl ::core::convert::From<GameProxyCall> for GamePlayerCalls {
        fn from(value: GameProxyCall) -> Self {
            Self::GameProxy(value)
        }
    }
    impl ::core::convert::From<InitCall> for GamePlayerCalls {
        fn from(value: InitCall) -> Self {
            Self::Init(value)
        }
    }
    impl ::core::convert::From<PlayCall> for GamePlayerCalls {
        fn from(value: PlayCall) -> Self {
            Self::Play(value)
        }
    }
    impl ::core::convert::From<TraceCall> for GamePlayerCalls {
        fn from(value: TraceCall) -> Self {
            Self::Trace(value)
        }
    }
    impl ::core::convert::From<TraceAtCall> for GamePlayerCalls {
        fn from(value: TraceAtCall) -> Self {
            Self::TraceAt(value)
        }
    }
    impl ::core::convert::From<TraceAtWithTraceIndexCall> for GamePlayerCalls {
