...
pub mod gas_bench_mark_l2_output_oracle {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("test_proposeL2Output_benchmark"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    pub static GASBENCHMARK_L2OUTPUTORACLE_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct GasBenchMark_L2OutputOracle<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for GasBenchMark_L2OutputOracle<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for GasBenchMark_L2OutputOracle<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for GasBenchMark_L2OutputOracle<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for GasBenchMark_L2OutputOracle<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(GasBenchMark_L2OutputOracle))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> GasBenchMark_L2OutputOracle<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    GASBENCHMARK_L2OUTPUTORACLE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                GASBENCHMARK_L2OUTPUTORACLE_ABI.clone(),
                GASBENCHMARK_L2OUTPUTORACLE_BYTECODE.clone().into(),
                client,
            );
        ...
        ///Calls the contract's `test_proposeL2Output_benchmark` (0x3fc15a4f) function
        pub fn test_propose_l2_output_benchmark(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([63, 193, 90, 79], ())
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            GasBenchMark_L2OutputOracleEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for GasBenchMark_L2OutputOracle<M> {
    ...
    pub enum GasBenchMark_L2OutputOracleEvents {
    ...
    impl ::ethers::contract::EthLogDecode for GasBenchMark_L2OutputOracleEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = OutputProposedFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::OutputProposedFilter(decoded),
                );
            }
            if let Ok(decoded) = OutputsDeletedFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::OutputsDeletedFilter(decoded),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::OwnershipTransferredFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = TransactionDepositedFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::TransactionDepositedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogAddressFilter(decoded));
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogArray1Filter(decoded));
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogArray2Filter(decoded));
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogArray3Filter(decoded));
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogBytesFilter(decoded));
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedAddressFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedArray1Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedArray2Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedArray3Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedBytesFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedBytes32Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedDecimalIntFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedDecimalUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogNamedIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedStringFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(
                    GasBenchMark_L2OutputOracleEvents::LogNamedUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogStringFilter(decoded));
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogUintFilter(decoded));
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(GasBenchMark_L2OutputOracleEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for GasBenchMark_L2OutputOracleEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GasBenchMark_L2OutputOracleEvents {
    ...
    impl ::core::convert::From<LogFilter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogFilter) -> Self {
            Self::LogFilter(value)
        }
    }
    impl ::core::convert::From<LogAddressFilter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogAddressFilter) -> Self {
            Self::LogAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogArray1Filter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogArray1Filter) -> Self {
            Self::LogArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogArray2Filter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogArray2Filter) -> Self {
            Self::LogArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogArray3Filter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogArray3Filter) -> Self {
            Self::LogArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogBytesFilter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogBytesFilter) -> Self {
            Self::LogBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogBytes32Filter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogBytes32Filter) -> Self {
            Self::LogBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogIntFilter> for GasBenchMark_L2OutputOracleEvents {
    ...
    impl ::core::convert::From<LogNamedIntFilter> for GasBenchMark_L2OutputOracleEvents {
    ...
    impl ::core::convert::From<LogStringFilter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogStringFilter) -> Self {
            Self::LogStringFilter(value)
        }
    }
    impl ::core::convert::From<LogUintFilter> for GasBenchMark_L2OutputOracleEvents {
        fn from(value: LogUintFilter) -> Self {
            Self::LogUintFilter(value)
        }
    }
    impl ::core::convert::From<LogsFilter> for GasBenchMark_L2OutputOracleEvents {
    ...
    ///Container type for all input parameters for the `test_proposeL2Output_benchmark` function with signature `test_proposeL2Output_benchmark()` and selector `0x3fc15a4f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "test_proposeL2Output_benchmark()"
    )]
    pub struct TestProposeL2OutputBenchmarkCall;
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GasBenchMark_L2OutputOracleCalls {
        IsTest(IsTestCall),
        ...
        TestProposeL2OutputBenchmark(TestProposeL2OutputBenchmarkCall),
        WarpToProposeTime(WarpToProposeTimeCall),
    }
    impl ::ethers::core::abi::AbiDecode for GasBenchMark_L2OutputOracleCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <TestProposeL2OutputBenchmarkCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::TestProposeL2OutputBenchmark(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for GasBenchMark_L2OutputOracleCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::TestProposeL2OutputBenchmark(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for GasBenchMark_L2OutputOracleCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsTestCall> for GasBenchMark_L2OutputOracleCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall>
    for GasBenchMark_L2OutputOracleCalls {
    ...
    impl ::core::convert::From<ExcludeSendersCall> for GasBenchMark_L2OutputOracleCalls {
        fn from(value: ExcludeSendersCall) -> Self {
            Self::ExcludeSenders(value)
        }
    }
    impl ::core::convert::From<FailedCall> for GasBenchMark_L2OutputOracleCalls {
    ...
    impl ::core::convert::From<SetUpCall> for GasBenchMark_L2OutputOracleCalls {
    ...
    impl ::core::convert::From<TargetSendersCall> for GasBenchMark_L2OutputOracleCalls {
        fn from(value: TargetSendersCall) -> Self {
            Self::TargetSenders(value)
        }
    }
    impl ::core::convert::From<TestProposeL2OutputBenchmarkCall>
    for GasBenchMark_L2OutputOracleCalls {
        fn from(value: TestProposeL2OutputBenchmarkCall) -> Self {
            Self::TestProposeL2OutputBenchmark(value)
        }
    }
