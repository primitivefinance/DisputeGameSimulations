...
pub mod honest_player {
    ...
    pub static HONESTPLAYER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct HonestPlayer<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for HonestPlayer<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for HonestPlayer<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for HonestPlayer<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for HonestPlayer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(HonestPlayer))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HonestPlayer<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                HONESTPLAYER_ABI.clone(),
                HONESTPLAYER_BYTECODE.clone().into(),
                client,
            );
    ...
    impl ::ethers::core::abi::AbiDecode for HonestPlayerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for HonestPlayerCalls {
    ...
    impl ::core::fmt::Display for HonestPlayerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ClaimAtCall> for HonestPlayerCalls {
        fn from(value: ClaimAtCall) -> Self {
            Self::ClaimAt(value)
        }
    }
    impl ::core::convert::From<ClaimAtWithPositionCall> for HonestPlayerCalls {
        fn from(value: ClaimAtWithPositionCall) -> Self {
            Self::ClaimAtWithPosition(value)
        }
    }
    impl ::core::convert::From<FailedToStepCall> for HonestPlayerCalls {
        fn from(value: FailedToStepCall) -> Self {
            Self::FailedToStep(value)
        }
    }
    impl ::core::convert::From<GameProxyCall> for HonestPlayerCalls {
        fn from(value: GameProxyCall) -> Self {
            Self::GameProxy(value)
        }
    }
    impl ::core::convert::From<InitCall> for HonestPlayerCalls {
        fn from(value: InitCall) -> Self {
            Self::Init(value)
        }
    }
    impl ::core::convert::From<PlayCall> for HonestPlayerCalls {
        fn from(value: PlayCall) -> Self {
            Self::Play(value)
        }
    }
    impl ::core::convert::From<TraceCall> for HonestPlayerCalls {
        fn from(value: TraceCall) -> Self {
            Self::Trace(value)
        }
    }
    impl ::core::convert::From<TraceAtCall> for HonestPlayerCalls {
        fn from(value: TraceAtCall) -> Self {
            Self::TraceAt(value)
        }
    }
    impl ::core::convert::From<TraceAtWithTraceIndexCall> for HonestPlayerCalls {
