...
pub mod honest_player_quarter_trace {
    ...
    pub static HONESTPLAYER_QUARTERTRACE_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct HonestPlayer_QuarterTrace<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for HonestPlayer_QuarterTrace<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for HonestPlayer_QuarterTrace<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for HonestPlayer_QuarterTrace<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for HonestPlayer_QuarterTrace<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(HonestPlayer_QuarterTrace))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HonestPlayer_QuarterTrace<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    HONESTPLAYER_QUARTERTRACE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                HONESTPLAYER_QUARTERTRACE_ABI.clone(),
                HONESTPLAYER_QUARTERTRACE_BYTECODE.clone().into(),
                client,
            );
    ...
    for HonestPlayer_QuarterTrace<M> {
    ...
    pub enum HonestPlayer_QuarterTraceCalls {
        ClaimAt(ClaimAtCall),
    ...
    impl ::ethers::core::abi::AbiDecode for HonestPlayer_QuarterTraceCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for HonestPlayer_QuarterTraceCalls {
    ...
    impl ::core::fmt::Display for HonestPlayer_QuarterTraceCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ClaimAtCall> for HonestPlayer_QuarterTraceCalls {
        fn from(value: ClaimAtCall) -> Self {
            Self::ClaimAt(value)
        }
    }
    impl ::core::convert::From<ClaimAtWithPositionCall>
    for HonestPlayer_QuarterTraceCalls {
        fn from(value: ClaimAtWithPositionCall) -> Self {
            Self::ClaimAtWithPosition(value)
        }
    }
    impl ::core::convert::From<FailedToStepCall> for HonestPlayer_QuarterTraceCalls {
        fn from(value: FailedToStepCall) -> Self {
            Self::FailedToStep(value)
        }
    }
    impl ::core::convert::From<GameProxyCall> for HonestPlayer_QuarterTraceCalls {
        fn from(value: GameProxyCall) -> Self {
            Self::GameProxy(value)
        }
    }
    impl ::core::convert::From<InitCall> for HonestPlayer_QuarterTraceCalls {
        fn from(value: InitCall) -> Self {
            Self::Init(value)
        }
    }
    impl ::core::convert::From<PlayCall> for HonestPlayer_QuarterTraceCalls {
        fn from(value: PlayCall) -> Self {
            Self::Play(value)
        }
    }
    impl ::core::convert::From<TraceCall> for HonestPlayer_QuarterTraceCalls {
        fn from(value: TraceCall) -> Self {
            Self::Trace(value)
        }
    }
    impl ::core::convert::From<TraceAtCall> for HonestPlayer_QuarterTraceCalls {
