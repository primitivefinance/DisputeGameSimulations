...
pub mod i_bond_manager {
    ...
    pub static IBONDMANAGER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> IBondManager<M> {
        ...
        pub fn bond_posted_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BondPostedFilter> {
            self.0.event()
        }
        ///Gets the contract's `BondReclaimed` event
        pub fn bond_reclaimed_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BondReclaimedFilter>
        {
            self.0.event()
        }
        ...
        pub fn bond_seized_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BondSeizedFilter> {
            self.0.event()
        }
        /// Returns an `Event` builder for all the events of this contract.
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IBondManagerEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IBondManager<M> {
    ...
    #[ethevent(
        name = "BondPosted",
        abi = "BondPosted(bytes32,address,uint256,uint256)"
    )]
    ...
    #[ethevent(
        name = "BondSeized",
        abi = "BondSeized(bytes32,address,address,uint256)"
    )]
    ...
    impl ::core::fmt::Display for IBondManagerEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::BondReclaimedFilter(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::ethers::core::abi::AbiDecode for IBondManagerCalls {
        fn decode(
            ...
            if let Ok(decoded) = <PostCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Post(decoded));
            }
            if let Ok(decoded) = <ReclaimCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) = <SeizeAndSplitCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for IBondManagerCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::SeizeAndSplit(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
