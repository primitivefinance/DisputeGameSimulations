...
pub mod lib_game_id {
    ...
    pub static LIBGAMEID_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static LIBGAMEID_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static LIBGAMEID_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for LibGameId<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(LibGameId))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for LibGameId<M> {
