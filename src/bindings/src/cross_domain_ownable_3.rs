pub use cross_domain_ownable_3::*;
...
pub mod cross_domain_ownable_3 {
    ...
    pub static CROSSDOMAINOWNABLE3_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct CrossDomainOwnable3<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for CrossDomainOwnable3<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for CrossDomainOwnable3<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for CrossDomainOwnable3<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for CrossDomainOwnable3<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(CrossDomainOwnable3))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> CrossDomainOwnable3<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            CrossDomainOwnable3Events,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for CrossDomainOwnable3<M> {
    ...
    pub enum CrossDomainOwnable3Events {
        OwnershipTransferred1Filter(OwnershipTransferred1Filter),
        OwnershipTransferred2Filter(OwnershipTransferred2Filter),
    }
    impl ::ethers::contract::EthLogDecode for CrossDomainOwnable3Events {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = OwnershipTransferred1Filter::decode_log(log) {
                return Ok(
                    CrossDomainOwnable3Events::OwnershipTransferred1Filter(decoded),
                );
            }
            if let Ok(decoded) = OwnershipTransferred2Filter::decode_log(log) {
                return Ok(
                    CrossDomainOwnable3Events::OwnershipTransferred2Filter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for CrossDomainOwnable3Events {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<OwnershipTransferred1Filter>
    for CrossDomainOwnable3Events {
        fn from(value: OwnershipTransferred1Filter) -> Self {
            Self::OwnershipTransferred1Filter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferred2Filter>
    for CrossDomainOwnable3Events {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum CrossDomainOwnable3Calls {
        IsLocal(IsLocalCall),
        Owner(OwnerCall),
    ...
    impl ::ethers::core::abi::AbiDecode for CrossDomainOwnable3Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for CrossDomainOwnable3Calls {
    ...
    impl ::core::fmt::Display for CrossDomainOwnable3Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsLocalCall> for CrossDomainOwnable3Calls {
        fn from(value: IsLocalCall) -> Self {
            Self::IsLocal(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for CrossDomainOwnable3Calls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for CrossDomainOwnable3Calls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipWithOwnerCall>
    for CrossDomainOwnable3Calls {
        fn from(value: TransferOwnershipWithOwnerCall) -> Self {
            Self::TransferOwnershipWithOwner(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for CrossDomainOwnable3Calls {
