pub use fault_dispute_game_init::*;
...
pub mod fault_dispute_game_init {
    ...
    impl<M: ::ethers::providers::Middleware> FaultDisputeGame_Init<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    FAULTDISPUTEGAME_INIT_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                FAULTDISPUTEGAME_INIT_ABI.clone(),
                FAULTDISPUTEGAME_INIT_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            FaultDisputeGame_InitEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for FaultDisputeGame_Init<M> {
    ...
    pub enum FaultDisputeGame_InitEvents {
    ...
    impl ::ethers::contract::EthLogDecode for FaultDisputeGame_InitEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = DisputeGameCreatedFilter::decode_log(log) {
                return Ok(
                    FaultDisputeGame_InitEvents::DisputeGameCreatedFilter(decoded),
                );
            }
            if let Ok(decoded) = ImplementationSetFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::ImplementationSetFilter(decoded));
            }
            if let Ok(decoded) = MoveFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::MoveFilter(decoded));
            }
            if let Ok(decoded) = OutputProposedFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::OutputProposedFilter(decoded));
            }
            if let Ok(decoded) = OutputsDeletedFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::OutputsDeletedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    FaultDisputeGame_InitEvents::OwnershipTransferredFilter(decoded),
                );
            }
            if let Ok(decoded) = TransactionDepositedFilter::decode_log(log) {
                return Ok(
                    FaultDisputeGame_InitEvents::TransactionDepositedFilter(decoded),
                );
            }
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogAddressFilter(decoded));
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogArray1Filter(decoded));
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogArray2Filter(decoded));
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogArray3Filter(decoded));
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogBytesFilter(decoded));
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedAddressFilter(decoded));
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedArray1Filter(decoded));
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedArray2Filter(decoded));
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedArray3Filter(decoded));
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedBytesFilter(decoded));
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    FaultDisputeGame_InitEvents::LogNamedDecimalIntFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    FaultDisputeGame_InitEvents::LogNamedDecimalUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedStringFilter(decoded));
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogNamedUintFilter(decoded));
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogStringFilter(decoded));
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogUintFilter(decoded));
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(FaultDisputeGame_InitEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for FaultDisputeGame_InitEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for FaultDisputeGame_InitEvents {
        fn from(value: DisputeGameCreatedFilter) -> Self {
            Self::DisputeGameCreatedFilter(value)
        }
    }
    impl ::core::convert::From<ImplementationSetFilter> for FaultDisputeGame_InitEvents {
        fn from(value: ImplementationSetFilter) -> Self {
            Self::ImplementationSetFilter(value)
        }
    }
    impl ::core::convert::From<MoveFilter> for FaultDisputeGame_InitEvents {
        fn from(value: MoveFilter) -> Self {
            Self::MoveFilter(value)
        }
    }
    impl ::core::convert::From<OutputProposedFilter> for FaultDisputeGame_InitEvents {
        fn from(value: OutputProposedFilter) -> Self {
            Self::OutputProposedFilter(value)
        }
    }
    impl ::core::convert::From<OutputsDeletedFilter> for FaultDisputeGame_InitEvents {
    ...
    impl ::core::convert::From<LogFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogFilter) -> Self {
            Self::LogFilter(value)
        }
    }
    impl ::core::convert::From<LogAddressFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogAddressFilter) -> Self {
            Self::LogAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogArray1Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogArray1Filter) -> Self {
            Self::LogArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogArray2Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogArray2Filter) -> Self {
            Self::LogArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogArray3Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogArray3Filter) -> Self {
            Self::LogArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogBytesFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogBytesFilter) -> Self {
            Self::LogBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogBytes32Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogBytes32Filter) -> Self {
            Self::LogBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogIntFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogIntFilter) -> Self {
            Self::LogIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedAddressFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedAddressFilter) -> Self {
            Self::LogNamedAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray1Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedArray1Filter) -> Self {
            Self::LogNamedArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray2Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedArray2Filter) -> Self {
            Self::LogNamedArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray3Filter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedArray3Filter) -> Self {
            Self::LogNamedArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytesFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedBytesFilter) -> Self {
            Self::LogNamedBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytes32Filter> for FaultDisputeGame_InitEvents {
    ...
    impl ::core::convert::From<LogNamedIntFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedIntFilter) -> Self {
            Self::LogNamedIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedStringFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedStringFilter) -> Self {
            Self::LogNamedStringFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedUintFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogNamedUintFilter) -> Self {
            Self::LogNamedUintFilter(value)
        }
    }
    impl ::core::convert::From<LogStringFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogStringFilter) -> Self {
            Self::LogStringFilter(value)
        }
    }
    impl ::core::convert::From<LogUintFilter> for FaultDisputeGame_InitEvents {
        fn from(value: LogUintFilter) -> Self {
            Self::LogUintFilter(value)
        }
    }
    impl ::core::convert::From<LogsFilter> for FaultDisputeGame_InitEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum FaultDisputeGame_InitCalls {
        IsTest(IsTestCall),
    ...
    impl ::ethers::core::abi::AbiDecode for FaultDisputeGame_InitCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for FaultDisputeGame_InitCalls {
    ...
    impl ::core::fmt::Display for FaultDisputeGame_InitCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsTestCall> for FaultDisputeGame_InitCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall> for FaultDisputeGame_InitCalls {
        fn from(value: ExcludeArtifactsCall) -> Self {
            Self::ExcludeArtifacts(value)
        }
    }
    impl ::core::convert::From<ExcludeContractsCall> for FaultDisputeGame_InitCalls {
        fn from(value: ExcludeContractsCall) -> Self {
            Self::ExcludeContracts(value)
        }
    }
    impl ::core::convert::From<ExcludeSendersCall> for FaultDisputeGame_InitCalls {
        fn from(value: ExcludeSendersCall) -> Self {
            Self::ExcludeSenders(value)
        }
    }
    impl ::core::convert::From<FailedCall> for FaultDisputeGame_InitCalls {
        fn from(value: FailedCall) -> Self {
            Self::Failed(value)
        }
    }
    impl ::core::convert::From<InitCall> for FaultDisputeGame_InitCalls {
        fn from(value: InitCall) -> Self {
            Self::Init(value)
        }
    }
    impl ::core::convert::From<ProposeAnotherOutputCall> for FaultDisputeGame_InitCalls {
        fn from(value: ProposeAnotherOutputCall) -> Self {
            Self::ProposeAnotherOutput(value)
        }
    }
    impl ::core::convert::From<SetUpCall> for FaultDisputeGame_InitCalls {
        fn from(value: SetUpCall) -> Self {
            Self::SetUp(value)
        }
    }
    impl ::core::convert::From<TargetArtifactSelectorsCall>
    for FaultDisputeGame_InitCalls {
        fn from(value: TargetArtifactSelectorsCall) -> Self {
            Self::TargetArtifactSelectors(value)
        }
    }
    impl ::core::convert::From<TargetArtifactsCall> for FaultDisputeGame_InitCalls {
        fn from(value: TargetArtifactsCall) -> Self {
            Self::TargetArtifacts(value)
        }
    }
    impl ::core::convert::From<TargetContractsCall> for FaultDisputeGame_InitCalls {
        fn from(value: TargetContractsCall) -> Self {
            Self::TargetContracts(value)
        }
    }
    impl ::core::convert::From<TargetSelectorsCall> for FaultDisputeGame_InitCalls {
        fn from(value: TargetSelectorsCall) -> Self {
            Self::TargetSelectors(value)
        }
    }
    impl ::core::convert::From<TargetSendersCall> for FaultDisputeGame_InitCalls {
        fn from(value: TargetSendersCall) -> Self {
            Self::TargetSenders(value)
        }
    }
    impl ::core::convert::From<WarpToProposeTimeCall> for FaultDisputeGame_InitCalls {
