pub use optimism_portal_can_always_finalize_after_window::*;
...
pub mod optimism_portal_can_always_finalize_after_window {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("invariant_canAlwaysFinalize"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    > OptimismPortal_CanAlwaysFinalizeAfterWindow<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    OPTIMISMPORTAL_CANALWAYSFINALIZEAFTERWINDOW_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                OPTIMISMPORTAL_CANALWAYSFINALIZEAFTERWINDOW_ABI.clone(),
                OPTIMISMPORTAL_CANALWAYSFINALIZEAFTERWINDOW_BYTECODE.clone().into(),
                client,
            );
        ...
        ///Calls the contract's `invariant_canAlwaysFinalize` (0xcf8a0401) function
        pub fn invariant_can_always_finalize(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([207, 138, 4, 1], ())
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            OptimismPortal_CanAlwaysFinalizeAfterWindowEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for OptimismPortal_CanAlwaysFinalizeAfterWindow<M> {
    ...
    pub enum OptimismPortal_CanAlwaysFinalizeAfterWindowEvents {
    ...
    for OptimismPortal_CanAlwaysFinalizeAfterWindowEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = OutputProposedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::OutputProposedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OutputsDeletedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::OutputsDeletedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::OwnershipTransferredFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = TransactionDepositedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::TransactionDepositedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalFinalizedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::WithdrawalFinalizedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalProvenFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::WithdrawalProvenFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogFilter(decoded),
                );
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogAddressFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogArray1Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogArray2Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogArray3Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogBytesFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogBytes32Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogIntFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedAddressFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedArray1Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedArray2Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedArray3Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedBytesFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedBytes32Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedDecimalIntFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedDecimalUintFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedIntFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedStringFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogNamedUintFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogStringFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogUintFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_CanAlwaysFinalizeAfterWindowEvents::LogsFilter(
                        decoded,
                    ),
                );
            }
    ...
    impl ::core::fmt::Display for OptimismPortal_CanAlwaysFinalizeAfterWindowEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    ///Container type for all input parameters for the `invariant_canAlwaysFinalize` function with signature `invariant_canAlwaysFinalize()` and selector `0xcf8a0401`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "invariant_canAlwaysFinalize()"
    )]
    pub struct InvariantCanAlwaysFinalizeCall;
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum OptimismPortal_CanAlwaysFinalizeAfterWindowCalls {
        IsTest(IsTestCall),
        ExcludeArtifacts(ExcludeArtifactsCall),
        ExcludeContracts(ExcludeContractsCall),
        ExcludeSenders(ExcludeSendersCall),
        Failed(FailedCall),
        InvariantCanAlwaysFinalize(InvariantCanAlwaysFinalizeCall),
    ...
    for OptimismPortal_CanAlwaysFinalizeAfterWindowCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <InvariantCanAlwaysFinalizeCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::InvariantCanAlwaysFinalize(decoded));
            }
    ...
    for OptimismPortal_CanAlwaysFinalizeAfterWindowCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::InvariantCanAlwaysFinalize(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for OptimismPortal_CanAlwaysFinalizeAfterWindowCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<InvariantCanAlwaysFinalizeCall>
    for OptimismPortal_CanAlwaysFinalizeAfterWindowCalls {
        fn from(value: InvariantCanAlwaysFinalizeCall) -> Self {
            Self::InvariantCanAlwaysFinalize(value)
        }
    }
