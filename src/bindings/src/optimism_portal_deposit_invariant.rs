pub use optimism_portal_deposit_invariant::*;
...
pub mod optimism_portal_deposit_invariant {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("invariant_deposit_completes"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    impl<M: ::ethers::providers::Middleware> OptimismPortal_Deposit_Invariant<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    OPTIMISMPORTAL_DEPOSIT_INVARIANT_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                OPTIMISMPORTAL_DEPOSIT_INVARIANT_ABI.clone(),
                OPTIMISMPORTAL_DEPOSIT_INVARIANT_BYTECODE.clone().into(),
                client,
            );
        ...
        ///Calls the contract's `invariant_deposit_completes` (0x33373990) function
        pub fn invariant_deposit_completes(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([51, 55, 57, 144], ())
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            OptimismPortal_Deposit_InvariantEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for OptimismPortal_Deposit_Invariant<M> {
    ...
    pub enum OptimismPortal_Deposit_InvariantEvents {
    ...
    impl ::ethers::contract::EthLogDecode for OptimismPortal_Deposit_InvariantEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = OutputProposedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::OutputProposedFilter(decoded),
                );
            }
            if let Ok(decoded) = OutputsDeletedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::OutputsDeletedFilter(decoded),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::OwnershipTransferredFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = TransactionDepositedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::TransactionDepositedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalFinalizedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::WithdrawalFinalizedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalProvenFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::WithdrawalProvenFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(OptimismPortal_Deposit_InvariantEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogAddressFilter(decoded),
                );
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogArray1Filter(decoded),
                );
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogArray2Filter(decoded),
                );
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogArray3Filter(decoded),
                );
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogBytesFilter(decoded),
                );
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogBytes32Filter(decoded),
                );
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(OptimismPortal_Deposit_InvariantEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedAddressFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedArray1Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedArray2Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedArray3Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedBytesFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedBytes32Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedDecimalIntFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedDecimalUintFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedIntFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedStringFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogNamedUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogStringFilter(decoded),
                );
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Deposit_InvariantEvents::LogUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(OptimismPortal_Deposit_InvariantEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for OptimismPortal_Deposit_InvariantEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for OptimismPortal_Deposit_InvariantEvents {
    ...
    impl ::core::convert::From<LogFilter> for OptimismPortal_Deposit_InvariantEvents {
    ...
    impl ::core::convert::From<LogIntFilter> for OptimismPortal_Deposit_InvariantEvents {
    ...
    impl ::core::convert::From<LogsFilter> for OptimismPortal_Deposit_InvariantEvents {
    ...
    ///Container type for all input parameters for the `invariant_deposit_completes` function with signature `invariant_deposit_completes()` and selector `0x33373990`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "invariant_deposit_completes()"
    )]
    pub struct InvariantDepositCompletesCall;
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum OptimismPortal_Deposit_InvariantCalls {
        IsTest(IsTestCall),
        ExcludeArtifacts(ExcludeArtifactsCall),
        ExcludeContracts(ExcludeContractsCall),
        ExcludeSenders(ExcludeSendersCall),
        Failed(FailedCall),
        InvariantDepositCompletes(InvariantDepositCompletesCall),
    ...
    impl ::ethers::core::abi::AbiDecode for OptimismPortal_Deposit_InvariantCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <InvariantDepositCompletesCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::InvariantDepositCompletes(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for OptimismPortal_Deposit_InvariantCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::InvariantDepositCompletes(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for OptimismPortal_Deposit_InvariantCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsTestCall> for OptimismPortal_Deposit_InvariantCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall>
    for OptimismPortal_Deposit_InvariantCalls {
    ...
    impl ::core::convert::From<FailedCall> for OptimismPortal_Deposit_InvariantCalls {
        fn from(value: FailedCall) -> Self {
            Self::Failed(value)
        }
    }
    impl ::core::convert::From<InvariantDepositCompletesCall>
    for OptimismPortal_Deposit_InvariantCalls {
        fn from(value: InvariantDepositCompletesCall) -> Self {
            Self::InvariantDepositCompletes(value)
        }
    }
    ...
    impl ::core::convert::From<SetUpCall> for OptimismPortal_Deposit_InvariantCalls {
