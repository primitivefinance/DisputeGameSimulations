pub use optimism_portal_invariant_harness::*;
...
pub mod optimism_portal_invariant_harness {
    ...
    pub static OPTIMISMPORTAL_INVARIANT_HARNESS_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct OptimismPortal_Invariant_Harness<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for OptimismPortal_Invariant_Harness<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for OptimismPortal_Invariant_Harness<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for OptimismPortal_Invariant_Harness<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for OptimismPortal_Invariant_Harness<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(OptimismPortal_Invariant_Harness))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> OptimismPortal_Invariant_Harness<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    OPTIMISMPORTAL_INVARIANT_HARNESS_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                OPTIMISMPORTAL_INVARIANT_HARNESS_ABI.clone(),
                OPTIMISMPORTAL_INVARIANT_HARNESS_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            OptimismPortal_Invariant_HarnessEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for OptimismPortal_Invariant_Harness<M> {
    ...
    pub enum OptimismPortal_Invariant_HarnessEvents {
    ...
    impl ::ethers::contract::EthLogDecode for OptimismPortal_Invariant_HarnessEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = OutputProposedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::OutputProposedFilter(decoded),
                );
            }
            if let Ok(decoded) = OutputsDeletedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::OutputsDeletedFilter(decoded),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::OwnershipTransferredFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = TransactionDepositedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::TransactionDepositedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalFinalizedFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::WithdrawalFinalizedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalProvenFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::WithdrawalProvenFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(OptimismPortal_Invariant_HarnessEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogAddressFilter(decoded),
                );
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogArray1Filter(decoded),
                );
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogArray2Filter(decoded),
                );
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogArray3Filter(decoded),
                );
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogBytesFilter(decoded),
                );
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogBytes32Filter(decoded),
                );
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(OptimismPortal_Invariant_HarnessEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedAddressFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedArray1Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedArray2Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedArray3Filter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedBytesFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedBytes32Filter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedDecimalIntFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedDecimalUintFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedIntFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedStringFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogNamedUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogStringFilter(decoded),
                );
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(
                    OptimismPortal_Invariant_HarnessEvents::LogUintFilter(decoded),
                );
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(OptimismPortal_Invariant_HarnessEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for OptimismPortal_Invariant_HarnessEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for OptimismPortal_Invariant_HarnessEvents {
    ...
    impl ::core::convert::From<LogFilter> for OptimismPortal_Invariant_HarnessEvents {
    ...
    impl ::core::convert::From<LogIntFilter> for OptimismPortal_Invariant_HarnessEvents {
    ...
    impl ::core::convert::From<LogsFilter> for OptimismPortal_Invariant_HarnessEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum OptimismPortal_Invariant_HarnessCalls {
        IsTest(IsTestCall),
    ...
    impl ::ethers::core::abi::AbiDecode for OptimismPortal_Invariant_HarnessCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for OptimismPortal_Invariant_HarnessCalls {
    ...
    impl ::core::fmt::Display for OptimismPortal_Invariant_HarnessCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsTestCall> for OptimismPortal_Invariant_HarnessCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall>
    for OptimismPortal_Invariant_HarnessCalls {
    ...
    impl ::core::convert::From<FailedCall> for OptimismPortal_Invariant_HarnessCalls {
    ...
    impl ::core::convert::From<SetUpCall> for OptimismPortal_Invariant_HarnessCalls {
