...
pub mod schema_resolver {
    ...
    impl ::ethers::core::abi::AbiDecode for SchemaResolverErrors {
        fn decode(
            ...
            if let Ok(decoded) = <InvalidEAS as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::core::convert::From<InvalidLength> for SchemaResolverErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for SchemaResolverCalls {
        fn decode(
            ...
            if let Ok(decoded) = <IsPayableCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
